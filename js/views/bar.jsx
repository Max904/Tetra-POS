...
import { Beer, CookingPot, Check, X, Timer, StickyNote, Users, Bell } from "lucide-react";
...
function BarView() {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "kds", children: [
    ...
    orders.length === 0 ? /* @__PURE__ */ jsxDEV("div", { className: "kds-empty", children: [
      ...
      // See kds.jsx for why this branches on timerStartMode and holds at 0
      // until the bar actually marks the ticket as preparing.
